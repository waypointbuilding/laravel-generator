...
class RequestGenerator extends BaseGenerator
{
    ...
    public function __construct(CommandData $commandData)
    {
        ...
        $this->createFileName = 'Create'.$this->commandData->modelName.$this->commandData->config->pathRequestNameSuffix.'.php';
        $this->updateFileName = 'Update'.$this->commandData->modelName.$this->commandData->config->pathRequestNameSuffix.'.php';
    }
